...
<script type="text/html" id="tpl">
    ...
    <tr>
        ...
        <td>
            <a href="javascript:;" data-id="{{ item.orderId }}" data-opt="view"
               class="layui-btn layui-btn-normal layui-btn-mini">查看详情</a>
            <a href="javascript:;" data-id="{{ item.orderId }}" data-opt="edit"
               class="layui-btn layui-btn-mini">发送通知</a>
