...
public class GoodsOrderController {
    ...
    private Logger _log = LoggerFactory.getLogger(GoodsOrderController.class);
    ...
    private final static String QR_PAY_URL = "http://localhost:8081/goods/qrPay.html";
    static final String AppID = "wx077cb62e341f8a5c";
    static final String AppSecret = "e663ea068f3e4f952f143de1432a35c2";

    private final static String GetOpenIdURL = "http://localhost:8081/goods/getOpenId";
    private final static String GetOpenIdURL2 = "http://localhost:8081/goods/getOpenId2";
...
//            _log.error(e, "执行业务异常,payOrderId=%s.mchOrderNo=%s", payOrderId, mchOrderNo);
            _log.error("执行业务异常,payOrderId=" + payOrderId + ".mchOrderNo=" + mchOrderNo + "", e);
        }
    ...
    void outResult(HttpServletResponse response, String content) {
        ...
        try {
            ...
            _log.error("response xxpay write exception.", e);
        }
    }
